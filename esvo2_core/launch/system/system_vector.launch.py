#!/usr/bin/env python3
"""
ROS2 launch file for ESVO2 system with Vector dataset configuration.
"""
...
def generate_launch_description():
    ...
    calib_dir_arg = DeclareLaunchArgument(
        'calib_dir',
        default_value=os.path.join(esvo2_core_share, 'calib', 'vector'),
    ...
    # Mapping node
    mapping_params_file = os.path.join(esvo2_core_share, 'cfg', 'mapping', 'mapping_vector_AA.yaml')
    esvo2_mapping = Node(
        package='esvo2_core',
    ...
    # Tracking node
    tracking_params_file = os.path.join(esvo2_core_share, 'cfg', 'tracking', 'tracking_vector_AA.yaml')
    esvo2_tracking = Node(
        package='esvo2_core',
