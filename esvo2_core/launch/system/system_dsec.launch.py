#!/usr/bin/env python3
"""
ROS2 launch file for ESVO2 system with DSEC dataset configuration.
"""
...
def generate_launch_description():
    ...
    # Mapping node
    mapping_params_file = os.path.join(esvo2_core_share, 'cfg', 'mapping', 'mapping_dsec_AA.yaml')
    esvo2_mapping = Node(
        package='esvo2_core',
    ...
    # Tracking node
    tracking_params_file = os.path.join(esvo2_core_share, 'cfg', 'tracking', 'tracking_dsec_AA.yaml')
    esvo2_tracking = Node(
        package='esvo2_core',
